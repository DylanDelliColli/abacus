...
| --- | --- | --- | --- | --- |
| `cargo test -p abacus-core` | 66 (full domain through ports rev 8: aggregate acceptance, activation-consuming authorize, state reads, worktree view) | 0.20s | 2026-08-04 | ABACUS-9NH.5/.6 |
